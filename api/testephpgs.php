...
$url_do_arquivo = "https://docs.google.com/spreadsheets/d/e/2PACX-1vSj46mJjviufX3dKQ6xioiLvPOHv9rq4RnqWhzLgvT6O4IbVN5PkilfS6S6PTisTrF39dx7FXtGH6vs/pub?gid=205422468&single=true&output=csv";
...
if (($identificador = fopen($url_do_arquivo, 'r')) !== FALSE) {
    ...
    while (($linha_do_arquivo = fgetcsv($identificador, 0, ",")) !== FALSE) {
        ...
        printf("%-10s %-19s %s <br />",  $linha_do_arquivo[0], $linha_do_arquivo[1], $linha_do_arquivo[2], $linha_do_arquivo[3], $linha_do_arquivo[4], $linha_do_arquivo[5]);
